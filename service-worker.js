const CACHE='valistruct-v3-0-rc6-jasp-import-v1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./jasp-import.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
